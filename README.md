...
**Equipment & Players**
*   **Board:** 7×7 squares
*   **Players:** 2-player: Red and Blue, each with 4 pieces
*   **Walls:** Unlimited, color-coded by player

**Game Flow**

**Placement Phase**
*   **Starting positions fixed:** Red [1,1],[5,5]; Blue [1,5],[5,1]. 
*   The other two are placed alternately: Red, Blue, Blue, Red
...
3.  **Place a wall** on an open side of that piece’s square (even if you moved 0 steps).

**Walls & Borders**
*   The board’s outer edge counts as a wall.
*   Walls cannot be removed once placed.
